...
#>
#Get the server list
$servers = Get-Content C:\DBA\Powershell\Serverlist.txt
...
$infoColl | Export-Csv -path C:\DBA\Server_Inventory_$((Get-Date).ToString('MM-dd-yyyy')).csv -NoTypeInformation #Export the results in csv file.