#Start PSRemoting 
Invoke-Command -ComputerName (Get-Content C:\DBA\Powershell\Serverlist.txt) -scriptblock { 
...
$infoObject 
} | Select-Object * -ExcludeProperty PSComputerName, RunspaceId, PSShowComputerName | Export-Csv -path C:\DBA\Server_Inventory_$((Get-Date).ToString('MM-dd-yyyy')).csv -NoTypeInformation