...
ALTER AVAILABILITY GROUP [AFTSQLHA1]  
 MODIFY REPLICA ON  
N'VHYTestCSQL01\SIMSAFTSQL1' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'TCP://VHYTestCSQL01.hywd.ipzo.net:1433')); 
ALTER AVAILABILITY GROUP [AFTSQLHA2]  
 MODIFY REPLICA ON  
N'VHYTestCSQL01\SIMSAFTSQL1' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'TCP://VHYTestCSQL01.hywd.ipzo.net:1433')); 
ALTER AVAILABILITY GROUP [AFTSQLHA3]  
 MODIFY REPLICA ON  
N'VHYTestCSQL01\SIMSAFTSQL1' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'TCP://VHYTestCSQL01.hywd.ipzo.net:1433')); 
ALTER AVAILABILITY GROUP [AFTSQLHA4]  
 MODIFY REPLICA ON  
N'VHYTestCSQL01\SIMSAFTSQL2' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'tcp://VHYTestCSql01.hywd.ipzo.net:52316')); 



ALTER AVAILABILITY GROUP [AFTSQLHA1]  
 MODIFY REPLICA ON  
N'VHYTestCSQL02\SIMSAFTSQL1' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'TCP://VHYTestCSQL02.hywd.ipzo.net:1433'));  
ALTER AVAILABILITY GROUP [AFTSQLHA2]  
 MODIFY REPLICA ON  
N'VHYTestCSQL02\SIMSAFTSQL1' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'TCP://VHYTestCSQL02.hywd.ipzo.net:1433'));  
...
ALTER AVAILABILITY GROUP [AFTSQLHA4]  
 MODIFY REPLICA ON  
N'VHYTestCSQL02\SIMSAFTSQL2' WITH   
(SECONDARY_ROLE (READ_ONLY_ROUTING_URL = N'tcp://VHYTestCSQL02.hywd.ipzo.net:58422')); 
...
MODIFY REPLICA ON  
N'VHYTestCSQL01\SIMSAFTSQL1' WITH   
(PRIMARY_ROLE (READ_ONLY_ROUTING_LIST=('VHYTestCSQL02\SIMSAFTSQL1','VHYTestCSQL01\SIMSAFTSQL1')));  
  
ALTER AVAILABILITY GROUP [AFTSQLHA1]   
MODIFY REPLICA ON  
N'VHYTestCSQL02\SIMSAFTSQL1' WITH   
(PRIMARY_ROLE (READ_ONLY_ROUTING_LIST=('VHYTestCSQL01\SIMSAFTSQL1','VHYTestCSQL02\SIMSAFTSQL1')));  
GO  
...
MODIFY REPLICA ON  
N'VHYTestCSQL01\SIMSAFTSQL2' WITH   
(PRIMARY_ROLE (READ_ONLY_ROUTING_LIST=('VHYTestCSQL02\SIMSAFTSQL2','VHYTestCSQL01\SIMSAFTSQL2')));  
  
ALTER AVAILABILITY GROUP [AFTSQLHA4]   
MODIFY REPLICA ON  
N'VHYTestCSQL02\SIMSAFTSQL2' WITH   
(PRIMARY_ROLE (READ_ONLY_ROUTING_LIST=('VHYTestCSQL01\SIMSAFTSQL2','VHYTestCSQL02\SIMSAFTSQL2')));  
GO  