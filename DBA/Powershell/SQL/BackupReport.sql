...
BUSETS.[type] ='L' 
AND 
BUSETS.backup_finish_date > DATEADD(DAY,-30,GETDATE())
)
,
...
--INSERT  ([ServerName], [Database_Name], [Compatibility_level], [Recovery_Model], [Recovery_Model_desc], [Database_Create_Date], [Backup_Completed], [Backup_Start_DateTime], [Backup_Finish_DateTime], [Duration_Min], [Days_Since_Last_Backup], [Last_Differential_DateTime], [Days_Since_Last_Differential_Backup], [Last_Log_Finish_DateTime], [Days_Since_Last_Log_Backup], [LOG_Backup_Size_MB], [Backup_Type], [Backup_Size_MB], [Backup_Size_Compressed_MB], [Device_type], [Physical_device_name], [Logical_device_name])
...
(DATEDIFF(DAY,BUSETS.backup_finish_date,GETDATE())) AS Days_Since_Last_Full_Backup,
...
(DATEDIFF(MINUTE,LASTLOGBACKUP.Last_Backup_Finish_DateTime,GETDATE()))AS Minutes_Since_Last_Log_Backup,
